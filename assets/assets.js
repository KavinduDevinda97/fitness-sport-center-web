...
import { Dumbbell, Heart, User, Flower2, Zap, Bike,  Users , Shield} from 'lucide-react'
...
export const services = [
  {
    ...
    features: ['Olympic Lifting Platforms', 'Full Free-Weight Range', 'Guided Training Programs', 'Video Library Access'],
  ...
  },
  {
    ...
    features: ['80+ Cardio Machines', 'Heart Rate Monitoring', 'Custom Cardio Plans', 'Interval Training Zones'],
  ...
  },
  {
    ...
    features: ['Certified Elite Trainers', 'Custom Program Design', 'Nutrition Guidance', 'Progress Tracking'],
  ...
  },
  {
    ...
    features: ['Hot Yoga Studio', 'All Skill Levels Welcome', '15+ Weekly Classes', 'Meditation Sessions'],
  ...
  },
  {
    ...
    features: ['Dedicated CrossFit Box', 'CF-L2 Certified Coaches', 'Daily WOD Programming', 'Scaled Options Available'],
  ...
  },
  {
    ...
    features: ['20+ Class Types Weekly', 'Live DJ Sessions', 'Community Challenges', 'Beginner-Friendly Options'],
...
export const contactInfo = [
  ...
  },
  {
    Icon: Clock,
    label: 'Hours',
    lines: ['Mon–Fri: 5:00 AM – 11:00 PM', 'Sat: 6:00 AM – 10:00 PM', 'Sun: 7:00 AM – 8:00 PM'],
  },
]