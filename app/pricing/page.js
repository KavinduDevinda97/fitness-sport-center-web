      ...
      <section className="py-16 bg-primary">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              return (
                ...
                >
                  ...
                  <div className={`p-8 ${plan.popular ? 'pt-12' : ''}`}>
                    {/* Header */}
                    <div className={`w-12 h-12 ${plan.bgAccent} rounded-sm flex items-center justify-center mb-5`}>
                    ...
                    <h3
                      className="text-4xl text-white tracking-wider mb-5 font-display"
                    ...
                    <div className="flex items-end gap-1 mb-1">
                      <span className="text-white/40 text-base font-semibold">Rs.</span>
                      <span
                        className="text-5xl sm:text-6xl text-white leading-none tracking-tight font-display"
                        
                      >
                        {plan.price.toLocaleString()}
                      </span>
                    </div>
                    <p className="text-white/30 text-xs uppercase tracking-widest mb-7">Per {plan.period}</p>
          ...
          <div className="mt-8 p-6 bg-secondary border border-accent rounded-sm flex flex-col sm:flex-row items-center justify-between gap-4">
            <div>
              <p className="text-white font-semibold text-sm">💡 Save with Annual Membership</p>
              <p className="text-white/50 text-sm mt-1">
                Pay annually and save up to 20%. Family bundles available — ask at the front desk.
              </p>
            </div>
            <Link
              href="/contact"
      ...
      {/* FAQ  */}
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <p className="text-accent text-xs font-bold uppercase tracking-[0.3em] mb-3">Membership FAQ</p>
            <h2
              className="text-5xl sm:text-6xl text-white leading-none tracking-wider font-display"
          ...
          <div className="space-y-4">
            {faqs.map((faq, i) => (
              <div key={i} className="p-6 bg-secondary border border-white/5 rounded-sm hover-border-accent transition-colors">
