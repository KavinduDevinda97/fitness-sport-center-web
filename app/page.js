      ...
      <section className="relative min-h-screen flex  justify-start overflow-hidden">
        ...
        <div className="relative flex ml-4 sm:ml-8 lg:ml-16 items-center z-10 max-w-7xl px-4 sm:px-6 lg:px-8 pt-24">
          <div className="max-w-3xl">
            <p className="text-brand-red text-xs sm:text-sm font-bold uppercase tracking-[0.4em] mb-4 animate-fade-in">
              ✦ Now Open in Colombo ✦
            </p>
            ...
            >
              <Link
                href="/pricing"
                className="inline-flex items-center gap-2 px-8 py-4 bg-accent text-white font-bold uppercase tracking-widest text-sm rounded-lg hover:bg-brand-red-light transition-all duration-300 shadow-lg shadow-brand-red/30 hover:shadow-brand-red/50 hover:gap-3 animate-pulse-red"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative">
              ...
              {/* Badge */}
              <div className="absolute -bottom-6 -right-6 w-28 h-28 bg-accent rounded-full flex flex-col items-center justify-center text-white z-10 shadow-2xl shadow-brand-red/40">
                <span
